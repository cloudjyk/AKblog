"""
Django settings for AKblog project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'user.momentjs.momentjs',
            ],
        },
    },
]

WSGI_APPLICATION = 'AKblog.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    ("avatars", os.path.join(STATIC_ROOT, 'avatars').replace('\\', '/')),
